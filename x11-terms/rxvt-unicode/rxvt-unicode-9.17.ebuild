...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-9.16-my_shortcuts.patch
	epatch "${FILESDIR}"/${PN}-9.16-my_paste_shortcut.patch
	epatch "${FILESDIR}"/${PN}-9.16-allow_arrow_scrolling.patch
	epatch "${FILESDIR}"/${PN}-9.16-current_working_directory_for_tabs.patch
	epatch "${FILESDIR}"/${PN}-9.16-focus_correct_tab.patch
	epatch "${FILESDIR}"/${PN}-9.16-add_tab_destroy_shortcut.patch
