...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-9.20-customized-keyboard-shortcuts-for-tabs.patch
	epatch "${FILESDIR}"/${PN}-9.20-added-custom-paste-shortcuts.patch
	epatch "${FILESDIR}"/${PN}-9.20-enabled-scoll-on-up-down-keys-feature.patch
	epatch "${FILESDIR}"/${PN}-9.20-added-better-current-working-directory-support-for-t.patch
	epatch "${FILESDIR}"/${PN}-9.20-fixed-tab-focusing-problem.patch
	epatch "${FILESDIR}"/${PN}-9.20-added-shortcut-for-destroying-a-tab.patch
