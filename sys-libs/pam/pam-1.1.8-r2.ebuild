...
src_prepare() {
	...
	# we require noyywrap option, otherwise we get error:
	# "undefined reference to `yywrap'"
	sed -i -e '1i%option noyywrap' conf/pam_conv1/pam_conv_l.l || die
	sed -i -e '1i%option noyywrap' doc/specs/parse_l.l || die
