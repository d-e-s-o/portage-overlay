...
https://github.com/Eloston/ungoogled-chromium/archive/${PV}-3.tar.gz -> ungoogled-chromium-${PV}.tar.gz"
...
src_unpack() {
	...
	# Ugh.
	mv ${WORKDIR}/ungoogled-chromium-${PV}-3 ${WORKDIR}/ungoogled-chromium-${PV} || die
}
